...
# 以現貨 ~44200 為中心，200 點間距，涵蓋 ±1000 點
SIMULATED_STRIKES: list[int] = [43200, 43400, 43600, 43800, 44000, 44200, 44400, 44600, 44800]

# --- MockFeed 專用參數（接真實 API 時不使用）---
SIMULATED_SPOT: float = 44200.0     # 模擬台指現貨價（2026/05 真實市場水準）
